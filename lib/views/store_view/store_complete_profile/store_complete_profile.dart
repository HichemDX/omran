...
class StoreCompleteProfile extends StatefulWidget {
  @override
  State<StoreCompleteProfile> createState() => _StoreCompleteProfileState();
}

class _StoreCompleteProfileState extends State<StoreCompleteProfile> {
  File? imageFile;
  ...
  _completeStoreProfile() async {
    if (formKey.currentState!.validate()) {
      Map<String, String> data = {
        ...
        "longitude": '0.0',
        "latitude": '0.0',
        "min_amount_order": '12.22',
      };

      Loader.show(context, progressIndicator: LoaderStyleWidget());
      authController
          .completeStoreProfile(data: data, imageFile: imageFile)
          .then((value) {
        Loader.hide();
      });
    }
                            ...
                            Row(
                              ...
                              children: [
                                FutureBuilder<List<Wilaya>>(
                                    future: wilayasController
                                        .initWilayaController(),
