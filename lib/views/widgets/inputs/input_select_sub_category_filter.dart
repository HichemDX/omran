...
class InputSelectSubCategoryFilter extends StatelessWidget {
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
              ...
              suffixIcon: Padding(
                ...
                child: PopupMenuButton<SubCategory>(
                  icon: isLoading
                      ? Container(
                          height: 14,
                          width: 14,
                  ...
                  itemBuilder: (BuildContext context) {
                    return list.map<PopupMenuItem<SubCategory>>((value) {
